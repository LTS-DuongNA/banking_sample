class GetInforFormImgModel {
  List<Responses>? responses;

  GetInforFormImgModel({this.responses});

  GetInforFormImgModel.fromJson(Map<String, dynamic> json) {
...
class Responses {
  ...
  Responses.fromJson(Map<String, dynamic> json) {
    ...
    fullTextAnnotation =
        json['fullTextAnnotation'] != null ? new FullTextAnnotation.fromJson(json['fullTextAnnotation']) : null;
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.textAnnotations != null) {
      data['textAnnotations'] = this.textAnnotations!.map((v) => v.toJson()).toList();
    }
...
class TextAnnotations {
  ...
  TextAnnotations.fromJson(Map<String, dynamic> json) {
    ...
    boundingPoly = json['boundingPoly'] != null ? new BoundingPoly.fromJson(json['boundingPoly']) : null;
  }
...
class Property {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.detectedLanguages != null) {
      data['detectedLanguages'] = this.detectedLanguages!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class Blocks {
  ...
  Blocks({this.boundingBox, this.paragraphs, this.blockType});

  Blocks.fromJson(Map<String, dynamic> json) {
    boundingBox = json['boundingBox'] != null ? new BoundingPoly.fromJson(json['boundingBox']) : null;
...
class Paragraphs {
  ...
  Paragraphs({this.boundingBox, this.words});
...
class Symbols {
  ...
  Symbols({this.boundingBox, this.text, this.property});
